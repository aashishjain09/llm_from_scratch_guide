import os, json, zstandard as zstd, tiktoken, h5py, argparse
...
def process_files(input_dir: str, output_file: str, tokenizer_name: str, max_data: Optional[int] = None) -> None:
    ...
    Args:
        ...
        output_files (str): Path to the output HDF5 file.
        tokenizer_name (str): Name of the tiktoken tokenizer to use (e.g., 'r50k_base').
        max_data (int, optional): Maximum number of lines to process from each file. If None, process all lines.
    """
